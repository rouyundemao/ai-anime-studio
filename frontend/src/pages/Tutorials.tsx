...
const modules = [
  {
    ...
    category: '核心理念',
    duration: '深度研习',
    description: '建立顶级动漫美学体系，理解东方美学与西方美学的完美融合，掌握留白艺术、意境营造、韵律节奏等核心美学原则。',
  ...
  },
  {
    ...
    category: '故事创作',
    duration: '深度创作',
    description: '电影级剧本结构设计，人物弧光打造，情感节奏把控。掌握三幕式结构、英雄之旅、救猫咪等经典剧本模型。',
  ...
  },
  {
    ...
    category: '角色设计',
    duration: '精细打磨',
    description: '顶级五官美学体系，发型服装设计，风格统一性控制。掌握三庭五眼、五官比例、服装体系等专业知识。',
  ...
  },
  {
    ...
    category: '世界观',
    duration: '宏大构建',
    description: '地理生态设定，文明文化创造，历史神话体系。构建完整的架空世界，让故事拥有深厚的土壤。',
  ...
  },
  {
    ...
    category: '画面制作',
    duration: '极致追求',
    description: '电影级画面构建，三层光影设计，细节精度控制。掌握构图法则、光影设计、电影级调色等专业技能。',
  ...
  },
  {
    ...
    category: '动画制作',
    duration: '精细调控',
    description: '物理真实感动画，情感动画表现，艺术化运动表达。掌握动画十二原则、情感表达技巧、电影级节奏控制。',
  ...
  },
  {
    ...
    category: '后期制作',
    duration: '艺术探索',
    description: '水墨与数字融合，手绘与AI结合，电影级后期制作。掌握水墨风格、手绘AI结合、电影后期全流程。',
            ...
            <div className={`bg-gradient-to-r ${module.color} p-8 text-white`}>
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="hidden md:block text-right">
                  ...
                  <div className="text-white/70 text-sm">/ 7</div>
                </div>
              </div>
